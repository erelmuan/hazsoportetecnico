...
/* @var $searchModel app\models\ParametrizacionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Parametrizaciones');
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Crear nuevas Parametrizaciones','class'=>'btn btn-default']).
...
<?= Html::encode('Listado de parametrización') ?>
</div>
</div>
<?php Modal::begin([
"id"=>"ajaxCrudModal",
