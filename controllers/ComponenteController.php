...
class ComponenteController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $tipocomponentes= Tipocomponente::arrayTipocomponentes();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Crear nuevo Componente",
                    'content'=>'<span class="text-success">Componente creado con exito</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Actualizar Componente #".$id,
    ...
    /**
     * Delete an existing Componente model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Componente model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
